...
class GetPizzaList {
    fun getList(): List<Pizza> {
        ...
        list.add(
            Pizza(8, R.raw.img_9,"Пепперони Фреш","Пикатна пепперони из цыплёнка, томаты, томаный соус, увеличенная порция моцаррелы",
        ...
        list.add(
            Pizza(9, R.raw.img_10,"Мясная","Цыплёнок, ветчина из цыплёнка, пикантная пепперони из цыплёнка, томатный соус, острая чоризо из цыплёнка, сыр моцарелла",
            60,Constants.PIZZA,false, mapOf(Constants.MALENKAYA to 60,Constants.SREDNAYA to 90, Constants.BOLSHAYA to 112),
        ...
        list.add(
            Pizza(10, R.raw.img_11,"Маргарита","Томаты, итальянские травы, томатный соус, увеличенная порция моцареллы",
        ...
        list.add(
            Pizza(11, R.raw.img_12,"Песто","Соус песто, соус альфредо, цыплёнок, кубики брынзы, томаты, моцарелла",
            60,Constants.PIZZA,false, mapOf(Constants.MALENKAYA to 60,Constants.SREDNAYA to 90, Constants.BOLSHAYA to 112),
        ...
        list.add(
            Pizza(12, R.raw.img_13,"Двойная пепперони","Пепперони из цыплёнка, томатный соус, моцарелла",
            60,Constants.PIZZA,false, mapOf(Constants.MALENKAYA to 60,Constants.SREDNAYA to 90, Constants.BOLSHAYA to 112),
        ...
        list.add(
            Pizza(13, R.raw.img_14,"Двойной цыплёнок","Цыплёнок, соу альфредо, моцарелла",
            37,Constants.PIZZA,false, mapOf(Constants.MALENKAYA to 37,Constants.SREDNAYA to 60, Constants.BOLSHAYA to 74),
        ...
        list.add(
            Pizza(14, R.raw.img_15,"Ветчина и сыр","Ветчина из цыплёнка, сыр моцарелла, соус альфредо",
        ...
        list.add(
            Pizza(15, R.raw.img_16,"Карбонара","Увеличенная порция моцареллы, смесь сыров чеддер и пармезан, сыр блю чиз, соус фльфредо",
        ...
        list.add(
            Pizza(16, R.raw.img_17,"Четыре сыра","Увеличенная порция моцареллы, смесь сыров чеддер и пармезан, сыр блю чиз, соус альфредо",
        ...
        list.add(
            Pizza(17, R.raw.img_18,"Четыре сезона","Сыр моцарлла, ветчина из цыплёнка, пикантная пепперони из цыплёнка, кубики брынзф, томаты, шампиньогы, томатный соус, итальянские травы",
            58,Constants.PIZZA,false, mapOf(Constants.MALENKAYA to 58,Constants.SREDNAYA to 88, Constants.BOLSHAYA to 110),
        ...
        list.add(
            Pizza(18, R.raw.img_19,"Деревенская","Картофель из печи, огурцы маринованные, цыплёнок, соус, чесночный ранч, томаты свежие, лук красный, чеснок, пицца-соус, сыр моцалрелла",
            58,Constants.PIZZA,false, mapOf(Constants.MALENKAYA to 58,Constants.SREDNAYA to 88, Constants.BOLSHAYA to 110),
        ...
        list.add(
            Pizza(19, R.raw.img_20,"Ветчина и грибы","Ветчина из цыплёнка, шампиньоны, томатный соус, увеличенная порция моцареллы",
        ...
        list.add(
            Pizza(20, R.raw.img_21,"3 пиццы","Комбо 2 пиццы 30см на любой вкус",
            225,Constants.COMBO,true, arrayCategory = arrayOf(Constants.PIZZA,Constants.PIZZA,Constants.PIZZA)
        )
        )

        list.add(
            Pizza(21, R.raw.img_22,"10 средних пицц","10 пицц 30см на любой вкусу. Для компании из 20-30 человек",
        ...
        list.add(
            Pizza(22, R.raw.img_23,"2 пиццы","Самое популяроне комбо из 2 пицц 30см. Большой выбор",
            156,Constants.COMBO, arrayCategory = arrayOf(Constants.PIZZA,Constants.PIZZA)
        )
        )

        list.add(
            Pizza(23, R.raw.img_24,"7 пицц","7 пицц 30см на любой вкус. Для компании из 15-20 человек",
        ...
        list.add(
            Pizza(24, R.raw.img_25,"2 пиццы и напиток","2 пиццы 25 см и напиток на выбор, Для компании из 2-4 человек",
            99,Constants.COMBO, arrayCategory = arrayOf(Constants.PIZZA,Constants.PIZZA,Constants.NAPITKI)
        )
        )

        list.add(
            Pizza(25, R.raw.img_26,"Пицца и 2 закуски","Пицца 30см и 2 закуски на выбор. Для компании из 2-4 человек",
            110,Constants.COMBO, arrayCategory = arrayOf(Constants.PIZZA,Constants.ZAKUSKI,Constants.ZAKUSKI)
        )
        )

        list.add(
            Pizza(26, R.raw.img_27,"4 Додстера","4 любых Додстера на выбор: Отсрый или Классический",
            89,Constants.COMBO, arrayCategory =  arrayOf(Constants.ZAKUSKI,Constants.ZAKUSKI,Constants.ZAKUSKI,Constants.ZAKUSKI)
        )
        )

        list.add(
            Pizza(27, R.raw.img_28,"Пицца, додстер, напиток и соус","Пицца 25см, додстер, напиток и соус. Для компании из 2-4 человек",
            85,Constants.COMBO, arrayCategory = arrayOf(Constants.PIZZA,Constants.ZAKUSKI,Constants.NAPITKI,Constants.SOUSI)
        )
        )

        list.add(
            Pizza(28, R.raw.img_29,"2 стартера","2 стартера",
            45,Constants.COMBO, arrayCategory = arrayOf(Constants.ZAKUSKI,Constants.ZAKUSKI))
        )

        list.add(
            Pizza(29, R.raw.img_31,"Две Кока-Колы Zero по суперцене","Две Кока-Колы Zero 0,5 по суперцене",
            10,Constants.COMBO, arrayCategory = arrayOf(Constants.NAPITKI,Constants.NAPITKI)
        )
        )

        list.add(
            Pizza(id = 30, image = R.raw.img_32, name = "Додстер", about = "Легендарная горячая закуска с цыплёнком, томатами, моцареллой, соусом ранч в тонкой пшеничной лепешке",
