...
import islom.din.dodo_ilmhona_proskills.data.Ingridients
...
class GetIngridientList()  {
    fun getList() : MutableList<Ingridients> {
        ...
        list.add(Ingridients(id = 1, name = "Соус альфредо", available = false))
        list.add(Ingridients(id = 2, name = "Мандарины"))
        list.add(Ingridients(id = 3 , name = "Цитровый соус",available = false))
        list.add(Ingridients(id = 4 , name = "Новогодгый соус",))
        list.add(Ingridients(id = 5 , name = "Cыр моцарелла", available = false))
        ...
        list.add(Ingridients(id = 9 , name = "Соус бургер",available = false))
        list.add(Ingridients(id = 10 , name = "Ветчина халяль",available = false))
        list.add(Ingridients(id = 11 , name = "Сыр моцарелла",available = false))
        ...
        list.add(Ingridients(id = 18 , name = "Томатный соус",available = false))
        list.add(Ingridients(id = 19 , name = "Увеличенная порция моцареллы",available = false))
        list.add(Ingridients(id = 20 , name = "NOTHING"))
